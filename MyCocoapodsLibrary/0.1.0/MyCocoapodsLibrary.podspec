...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/mehiretabPulsemusic/MyCocoapodsLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mehiretabPulsemusic' => 'mehiretab333@gmail.com' }
  s.source           = { :git => 'https://github.com/mehiretabPulsemusic/MyCocoapodsLibrary.git', :tag => s.version.to_s }
